...
namespace Phone_Book.Persistance.Migrations
{
    ...
    partial class DataBaseContext_PhonebookModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Phone_Book.Domain.Entities.User.Role_Phonebook", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 12, 17, 16, 10, 54, 129, DateTimeKind.Local).AddTicks(4170),
                            Isremoved = false,
                            Name = "مدیریت",
                        ...
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 12, 17, 16, 10, 54, 137, DateTimeKind.Local).AddTicks(8116),
                            Isremoved = false,
                            Name = "اپراتور",
                            RemoveTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        ...
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2021, 12, 17, 16, 10, 54, 137, DateTimeKind.Local).AddTicks(8421),
                            Isremoved = false,
                            Name = "همکار",
                            RemoveTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
